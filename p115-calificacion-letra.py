#Ejemplo de una funcion que regresa dos valores
import os
def calif_letra(p):
    l=''; m=''
...
os.system('cls')
print('Dame tu promedio y te dare tu calificcacion con letra y un mensaje')
while True:
    p=int(input('Promedio (1-100): '))
    if p>=1 and p<=100: break
l,m=calif_letra(p)
print(f'Tu promedio de {p} tiene una calificacion de {l}, por lo tanto {m}')
